...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToLogin, onQuickLogin }) => {
  return (
    <div className="min-h-screen bg-[#05070c] text-slate-100 flex flex-col relative overflow-hidden">
      ...
      {/* Header */}
      <header className="border-b border-slate-800/50 py-5 px-6 relative z-10 backdrop-blur-md bg-[#05070c]/60">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-[#090d16]/80 border border-slate-700 text-sm font-semibold hover:bg-brand-orange hover:text-white hover:border-brand-orange transition-all duration-300 shadow-md hover:shadow-brand-orange/20"
          >
            Se Connecter
          </button>
        </div>
      ...
      <section className="flex-1 max-w-7xl mx-auto px-6 py-16 lg:py-24 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7 flex flex-col gap-6 text-left">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight text-white leading-[1.1] !my-0 drop-shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            <a
              href="#demo-section"
              className="px-8 py-4 rounded-2xl bg-[#090d16]/80 border border-slate-700 text-slate-300 font-bold text-lg hover:bg-slate-800 transition-all duration-300 text-center flex items-center justify-center hover:-translate-y-1"
            >
              Accès Démo Sécurisé
            </a>
          </div>
        ...
        <div className="lg:col-span-5 grid sm:grid-cols-2 gap-4">
          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors text-left backdrop-blur-xl hover:border-brand-orange/30">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Base de Données InsForge</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
              Vos données clients sont sauvegardées en ligne instantanément et en toute sécurité.
            </p>
          </div>

          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors text-left backdrop-blur-xl hover:border-brand-emerald/30">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Offline-First Intelligent</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
              Continuez d'enregistrer des données même sans internet. La synchronisation se fera automatiquement.
            </p>
          </div>

          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors text-left backdrop-blur-xl hover:border-amber-400/30">
            ...
            <h3 className="text-xl font-bold text-white mb-2">GPS et Terrain</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
              Capturez la position exacte de vos commerciaux lors des visites clients pour plus de transparence.
            </p>
          </div>

          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors text-left backdrop-blur-xl hover:border-blue-500/30">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Sécurité et Rôles</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
      ...
      {/* Demo Roles Section */}
      <section id="demo-section" className="bg-[#090d16]/50 border-t border-slate-800/50 py-20 px-6 relative z-10 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800 text-slate-300 text-xs font-bold uppercase tracking-widest mb-6">
            Espace Test
          </div>
          <h2 className="text-4xl font-black text-white mb-4 drop-shadow-lg">Accès Sécurisé Super Admin</h2>
          ...
          <div className="max-w-md mx-auto">
            {/* Super Admin Demo */}
            <div className="p-8 rounded-3xl bg-gradient-to-b from-[#0a0f1c] to-[#05070c] border border-brand-orange/30 shadow-[0_0_40px_rgba(249,115,22,0.1)] flex flex-col items-center text-center relative overflow-hidden group hover:border-brand-orange/60 transition-all duration-500">
              ...
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-brand-orange to-amber-600 flex items-center justify-center mb-6 shadow-xl shadow-brand-orange/20 border-4 border-[#05070c] relative z-10">
                <ShieldCheck className="w-10 h-10 text-white" />
              </div>
              
              <h3 className="text-2xl font-black text-white mb-1 relative z-10">Soro Nagony Adama</h3>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800/50 py-8 px-6 text-center text-sm text-slate-500 relative z-10 backdrop-blur-md bg-[#05070c]/50">
