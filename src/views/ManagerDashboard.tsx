...
export const ManagerDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden flex flex-col md:flex-row text-slate-900">
      ...
      {/* Sidebar for Desktop */}
      <aside className="hidden md:flex flex-col w-64 glass-sidebar m-4 mr-2 rounded-[2rem] p-6 h-[calc(100vh-2rem)] sticky top-4 justify-between shrink-0 shadow-2xl relative z-20">
      ...
      <header className="md:hidden glass-card border-b border-white/60 px-4 py-3 sticky top-0 z-35 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-orange-500 to-brand-emerald flex items-center justify-center font-black text-white text-md shadow-md">
            DJ
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={logout}
            className="p-2 rounded-lg bg-slate-50/50 border border-slate-200/50 text-slate-400 hover:text-red-600 backdrop-blur-sm"
          >
            <LogOut className="w-4 h-4" />
          </button>
        </div>
      ...
      <div className="md:hidden flex overflow-x-auto glass-card border-b border-white/60 p-2 gap-1.5 scrollbar-none shrink-0 rounded-none shadow-sm">
        {(['team', 'reporting', 'orders', 'segments', 'kanban', 'feed', 'reassign', 'recruit', 'templates'] as const).map(tab => (
          <button
            ...
            className={`flex-none px-4 py-2 rounded-lg text-xs font-bold transition-all uppercase ${
              activeTab === tab ? 'bg-gradient-to-r from-emerald-500 to-emerald-400 text-white shadow-md' : 'text-slate-500 hover:bg-white/40'
            }`}
          >
      ...
      <main className="flex-1 flex flex-col m-4 md:ml-2 bg-white/40 backdrop-blur-3xl rounded-[2rem] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative z-10 overflow-hidden">
        <div className="flex-1 overflow-y-auto px-6 py-8 md:py-10 max-w-7xl mx-auto w-full">
        {/* Module Header Title */}
        ...
        {activeTab === 'team' && (
          <div className="flex flex-col gap-8 text-left animate-fade-in">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md flex items-center justify-between shadow-xl">
                <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="p-6 rounded-[2rem] glass-card border border-slate-200 flex flex-col gap-3">
                <div className="flex justify-between items-center">
            ...
            {/* Team Clients table */}
            <div className="p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md shadow-xl">
        ...
        {activeTab === 'reporting' && (
          <div className="flex flex-col gap-6 text-left animate-fade-in">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-5 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md">
            ...
            <div className="p-6 rounded-[2rem] glass-card border border-slate-200/80">
        ...
        {activeTab === 'segments' && (
          <div className="grid lg:grid-cols-3 gap-8 text-left animate-fade-in">
            {/* Create segment form */}
            <div className="p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md shadow-xl flex flex-col gap-6">
              <div>
            ...
            {/* List segments */}
            <div className="lg:col-span-2 p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md shadow-xl flex flex-col gap-4">
...
{/* Tab: Reassign */}
        {activeTab === 'reassign' && (
          <div className="p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md text-left max-w-xl mx-auto shadow-xl animate-fade-in flex flex-col gap-6">
        ...
        {activeTab === 'recruit' && (
          <div className="grid lg:grid-cols-2 gap-8 text-left animate-fade-in">
            ...
            <div className="p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md shadow-xl flex flex-col gap-4">
        ...
        {/* Tab: Templates */}
        {activeTab === 'templates' && (
          <div className="p-6 rounded-2xl glass-card border border-white/40 shadow-xl backdrop-blur-md text-left max-w-2xl mx-auto shadow-xl flex flex-col gap-6 animate-fade-in">
            ...
            <div className="flex flex-col gap-4">
              {whatsappTemplates.map(t => (
                <div key={t.id} className="p-4 rounded-[1.5rem] glass-card border border-slate-850 flex flex-col gap-2">
                  <div className="flex justify-between items-center">
      ...
      {selectedClientForModal && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xl z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-3xl bg-white/95 border border-white rounded-[2rem] p-8 shadow-[0_20px_60px_rgb(0,0,0,0.15)] flex flex-col gap-5 text-left max-h-[85vh] overflow-y-auto">
