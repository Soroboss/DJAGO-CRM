    ...
    <div className="min-h-screen bg-[#05070c] text-slate-100 flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-[#090d16] border-r border-slate-800/60 p-6 h-screen sticky top-0 justify-between shrink-0">
        <div className="flex flex-col gap-8">
          ...
          <div className="p-3.5 rounded-xl bg-[#05070c]/50 border border-slate-800/85 text-left">
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Connecté en tant que</p>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold tracking-wide transition-all ${
                activeTab === 'kpis'
                  ...
                  : 'text-slate-400 hover:text-slate-200 hover:bg-[#05070c]/30'
              }`}
            >
      ...
      <header className="md:hidden bg-[#090d16] border-b border-slate-800/60 px-4 py-3 sticky top-0 z-35 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-md font-bold text-white">DjagoCRM DG</span>
        </div>
        ...
        {(['kpis', 'transactions', 'orders', 'forms', 'kanban', 'feed', 'admin', 'audit', 'templates'] as const).map(tab => (
          <button
            ...
            className={`flex-none px-4 py-2 rounded-lg text-xs font-bold transition-all uppercase ${
              activeTab === tab ? 'bg-brand-orange text-white' : 'text-slate-400 bg-slate-950/30'
            }`}
          >
      ...
      <main className="flex-1 overflow-y-auto px-6 py-8 md:py-10 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col gap-8 animate-fade-in text-left">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-slate-950/45 border border-slate-800 flex items-center justify-between shadow-xl">
                ...
                <div className="w-12 h-12 rounded-xl bg-slate-800 text-slate-400 flex items-center justify-center border border-slate-700">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-[#090d16] border border-slate-800 flex flex-col gap-4 shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">CAC Moyen (Acquisition)</span>
                    <span className="text-xs font-black text-slate-200 block mt-1">120 000 FCFA</span>
                  </div>
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">LTV Client (Valeur à vie)</span>
                    <span className="text-xs font-black text-slate-200 block mt-1">1 850 000 FCFA</span>
                  </div>
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">Efficacité LTV/CAC</span>
                  ...
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">Marge brute nette</span>
              ...
              <div className="p-6 rounded-2xl bg-[#090d16] border border-slate-800 flex flex-col gap-4 shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">Cycle de vente moyen</span>
                    <span className="text-xs font-black text-slate-200 block mt-1">12.4 jours</span>
                  </div>
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">Délai Résolution SAV</span>
                    <span className="text-xs font-black text-slate-200 block mt-1">18 minutes</span>
                  </div>
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">Taux d'automatisation IA</span>
                    <span className="text-xs font-black text-brand-orange block mt-1">86.2%</span>
                  </div>
                  <div className="bg-slate-950/45 p-3.5 rounded-xl border border-slate-850">
                    <span className="text-[9px] text-slate-500 font-bold block uppercase">Check-ins GPS Terrain</span>
        ...
        {activeTab === 'transactions' && (() => {
          ...
          return (
            <div className="flex flex-col gap-6 text-left animate-fade-in">
              {/* Deals KPIs */}
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Volume total & Win-Rate</span>
                  <h4 className="text-xl font-black text-white">{totalDeals} opportunités</h4>
                ...
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Pipeline Brut Actif</span>
                ...
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Pipeline Pondéré IA</span>
                ...
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Chiffre Gagné (Won)</span>
              ...
              <div className="p-6 rounded-2xl bg-slate-950/45 border border-slate-800 shadow-xl">
                <h3 className="text-base font-bold text-white mb-4">Suivi Financier National des Deals</h3>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {transactions.map((trans) => {
                        let stageBadge = 'bg-slate-800 text-slate-350';
                        ...
                        return (
                          <tr key={trans.id} className="border-b border-slate-850 hover:bg-slate-900/30">
                            <td className="py-3 px-4 font-bold text-white">{trans.title}</td>
                            ...
                            <td className="py-3 px-4">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] text-slate-450 font-bold font-mono">{trans.probability}%</span>
                              </div>
                            </td>
                            <td className="py-3 px-4 text-slate-450">{trans.expected_close_date}</td>
        ...
        {activeTab === 'orders' && (() => {
          ...
          return (
            <div className="flex flex-col gap-6 text-left animate-fade-in">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Total Bons Commandes</span>
                  <h4 className="text-xl font-black text-white">{totalOrders} Commandes</h4>
                  <div className="text-[10px] text-slate-400 font-semibold">{activeDeliveries} livraisons en cours</div>
                </div>

                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">CA Encaissé (Payé)</span>
                ...
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Vélocité Logistique</span>
                ...
                <div className="p-5 rounded-2xl bg-slate-950/45 border border-slate-800 flex flex-col gap-1.5 shadow-md">
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Retards ou Anomalies</span>
              ...
              {/* Orders Table */}
              <div className="p-6 rounded-2xl bg-slate-950/45 border border-slate-800 shadow-xl">
                <h3 className="text-base font-bold text-white mb-4">Logistique de Commandes & Factures Nationales</h3>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-800 text-slate-400 text-xs">
                    ...
                    <tbody>
                      {orders.map((order) => {
                        ...
                        let payBadge = 'bg-slate-800 text-slate-350';
                        ...
                        let delBadge = 'bg-slate-800 text-slate-350';
                        ...
                        return (
                          <tr key={order.id} className="border-b border-slate-850 hover:bg-slate-900/30">
                            ...
                            <td className="py-3 px-4 font-semibold text-slate-300">{order.items}</td>
                            ...
                            <td className="py-3 px-4 text-xs text-slate-450">{new Date(order.created_at).toLocaleDateString()}</td>
                          </tr>
                        );
                      })}
                    </tbody>
        ...
        {activeTab === 'forms' && (
          <div className="grid lg:grid-cols-3 gap-6 text-left animate-fade-in">
            {/* Creator form */}
            <div className="p-6 rounded-2xl bg-slate-955 border border-slate-800 shadow-xl flex flex-col gap-5">
              <div>
                <h3 className="text-base font-bold text-white">Nouveau Formulaire Public</h3>
                <p className="text-[11px] text-slate-450 mt-1">Configurez un formulaire public pour capturer des prospects.</p>
              </div>
              ...
              <form onSubmit={handleCreateForm} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2 bg-slate-950/50 p-3 rounded-xl border border-slate-900 text-xs text-slate-300">
            ...
            <div className="p-6 rounded-2xl bg-slate-955 border border-slate-800 shadow-xl flex flex-col gap-4">
              <div>
                <h3 className="text-base font-bold text-white">Aperçu Live du Formulaire</h3>
                <p className="text-[11px] text-slate-450 mt-1">Rendu dynamique public visible par les clients.</p>
              </div>
              ...
              <div className="flex-1 bg-gradient-to-br from-brand-orange/5 to-slate-950 p-5 rounded-xl border border-slate-850/80 flex flex-col justify-between min-h-[300px]">
                <div className="flex flex-col gap-3">
                  <div className="border-b border-slate-850 pb-2">
                    <h4 className="text-xs font-black text-slate-100">{formTitle || "Aperçu de votre formulaire"}</h4>
                  ...
                  <div className="flex flex-col gap-2.5 text-left">
                    {selectedFields.includes('name') && (
                      <div className="flex flex-col gap-1">
                        ...
                        <input type="text" disabled placeholder="M. Konan Jean" className="p-2 bg-slate-900/60 border border-slate-800 rounded-lg text-[10px] text-slate-400" />
                      </div>
                    )}
                    {selectedFields.includes('phone') && (
                      <div className="flex flex-col gap-1">
                        <label className="text-[9px] font-bold text-slate-400 uppercase">Téléphone *</label>
                        <input type="tel" disabled placeholder="+225 0707..." className="p-2 bg-slate-900/60 border border-slate-800 rounded-lg text-[10px] text-slate-400" />
                      </div>
                    )}
                    {selectedFields.includes('company') && (
                      <div className="flex flex-col gap-1">
                        <label className="text-[9px] font-bold text-slate-400 uppercase">Entreprise</label>
                        <input type="text" disabled placeholder="Cacao Trading Inc." className="p-2 bg-slate-900/60 border border-slate-800 rounded-lg text-[10px] text-slate-400" />
                      </div>
                    )}
                    {selectedFields.includes('email') && (
                      <div className="flex flex-col gap-1">
                        <label className="text-[9px] font-bold text-slate-400 uppercase">Adresse e-mail</label>
                        <input type="email" disabled placeholder="jean@cacao.ci" className="p-2 bg-slate-900/60 border border-slate-800 rounded-lg text-[10px] text-slate-400" />
                      </div>
                    )}
                  </div>
                </div>
            ...
            {/* Existing forms list */}
            <div className="p-6 rounded-2xl bg-[#090d16] border border-slate-800 shadow-xl flex flex-col gap-4">
              <h3 className="text-base font-bold text-white">Formulaires actifs</h3>
              <div className="flex flex-col gap-3 overflow-y-auto max-h-[400px] scrollbar-none">
                {forms.length === 0 ? (
                  <p className="text-xs text-slate-500 italic py-6 text-center">Aucun formulaire configuré.</p>
                ) : (
                  forms.map((f, idx) => {
                    ...
                    return (
                      <div key={f.id} className="p-4 rounded-xl bg-slate-950 border border-slate-850 flex flex-col gap-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <h4 className="text-xs font-extrabold text-slate-200">{f.title}</h4>
                        ...
                        {/* Performance metrics */}
                        <div className="grid grid-cols-2 gap-2 text-[9px] bg-slate-900/50 p-2 rounded-lg border border-slate-900">
                          <div>
                            <span className="text-slate-500 font-bold block">SOUMISSIONS</span>
                            <span className="font-extrabold text-slate-300">{simulatedSubmissions} leads</span>
                          </div>
                          <div>
                            <span className="text-slate-500 font-bold block">CONVERSION</span>
                        ...
                        {/* Public Link Copy */}
                        <div className="flex flex-col gap-1">
                          <span className="text-[8px] font-bold text-slate-450 uppercase">Lien public d'acquisition</span>
                        ...
                        {/* Embed iframe Copy */}
                        <div className="flex flex-col gap-1">
                          <span className="text-[8px] font-bold text-slate-450 uppercase">Intégration iframe Web</span>
                          <div className="flex gap-1">
                            <input 
                              type="text" readOnly value={embedHtml}
                              className="p-1.5 bg-slate-950 border border-slate-900 rounded text-[9px] text-slate-450 cursor-text w-full focus:outline-none font-mono truncate"
                            />
                            <button
                              onClick={() => {
                ...
                return (
                  <div key={int.id} className="relative flex flex-col gap-1.5 pb-2 text-left">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-500 font-semibold">
                      ...
                      <span>•</span>
                      <span className="text-slate-350">{comm?.name || 'Système'} ({comm?.zone || 'Zone Globale'})</span>
                    </div>
        ...
        {activeTab === 'admin' && (
          <div className="grid lg:grid-cols-12 gap-8 text-left animate-fade-in">
            <div className="lg:col-span-5 p-6 rounded-2xl bg-slate-950/45 border border-slate-800 shadow-xl flex flex-col gap-6">
              <form onSubmit={handleCreateCollab} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 focus:outline-none focus:border-brand-orange text-sm text-slate-200"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      className="px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 focus:outline-none focus:border-brand-orange text-sm text-slate-300"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      className="px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:border-brand-orange text-sm text-slate-300"
                    >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    disabled
                    value={newCollabPass}
                    className="px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-500 text-sm cursor-not-allowed"
                  />
                </div>
            ...
            <div className="lg:col-span-7 p-6 rounded-2xl bg-slate-950/45 border border-slate-800 shadow-xl flex flex-col gap-4">
              <h3 className="text-lg font-bold text-white">Équipe Commerciale</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-800 text-slate-400 text-xs">
                      ...
                      <tr key={t.id} className="border-b border-slate-850 hover:bg-slate-900/30">
                        ...
                        <td className="py-3 px-4">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${
                            ...
                            t.role === 'manager' ? 'bg-brand-emerald/15 text-brand-emerald' : 'bg-slate-800 text-slate-400'
                          }`}>
                            {t.role}
                          </span>
                        </td>
                        <td className="py-3 px-4 text-slate-350">{t.zone}</td>
        ...
        {activeTab === 'audit' && (
          <div className="flex flex-col gap-6 text-left animate-fade-in">
            <div className="p-6 rounded-2xl bg-slate-950/45 border border-slate-800 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2 w-full sm:w-72">
                ...
                <select
                  ...
                  className="pl-9 pr-4 py-2.5 w-full rounded-xl bg-slate-955 border border-slate-800 focus:outline-none focus:border-brand-orange text-sm text-slate-350"
                >
            ...
            <div className="p-6 rounded-2xl bg-slate-950/45 border border-slate-800 shadow-xl">
              <h3 className="text-lg font-bold text-white mb-6">Chronologie des Actions Relances</h3>
              
              {filteredInteractions.length === 0 ? (
                <p className="text-sm text-slate-400 py-6 text-center">Aucune interaction enregistrée pour cette sélection.</p>
              ) : (
                <div className="flex flex-col gap-6 border-l border-slate-800 pl-6 ml-4">
                    ...
                    return (
                      <div key={int.id} className="relative flex flex-col gap-1.5 text-left">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="text-xs font-bold text-slate-350">{agent?.name}</span>
                          <span className="text-slate-650">•</span>
                          <span className="text-xs text-slate-450 font-medium">Client : <span className="font-semibold text-slate-200">{client?.name || 'Inconnu'}</span></span>
                        </div>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl flex flex-col gap-5 text-left max-h-[85vh] overflow-y-auto">
            ...
            <div className="border-t border-slate-800 pt-4 flex flex-col gap-4">
              <h4 className="font-bold text-white text-sm uppercase">Fiche Contacts & Transactions associées</h4>
              <div className="grid sm:grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  {contacts.filter(c => c.client_id === selectedClientForModal.id).length === 0 ? (
                    <p className="text-slate-500 italic">Aucun contact enregistré.</p>
                  ) : (
                    contacts.filter(c => c.client_id === selectedClientForModal.id).map(c => (
                      <div key={c.id} className="p-2 rounded bg-slate-950 border border-slate-850 mb-1">
                        <p className="font-bold text-slate-200">{c.name} ({c.role})</p>
            ...
            <div className="border-t border-slate-800 pt-4">
              <h4 className="font-bold text-white text-sm uppercase mb-2">Tickets SAV de ce Client</h4>
                ...
                tickets.filter(t => t.client_id === selectedClientForModal.id).map(t => (
                  <div key={t.id} className="p-3 rounded-xl bg-slate-955 border border-slate-850 mb-2 flex justify-between items-center text-xs">
                    ...
                    <div className="flex gap-2">
                      ...
                      <span className="px-2 py-0.5 rounded text-[9px] bg-slate-950 text-slate-400 border border-slate-800 font-bold">{t.status}</span>
                    </div>
                  </div>
                ))
              )}
