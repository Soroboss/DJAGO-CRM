...
import { TeamManagementModule } from '../components/TeamManagementModule';
import { AuditLogsModule } from '../components/AuditLogsModule';
import { WhatsAppTemplatesModule } from '../components/WhatsAppTemplatesModule';
import { 
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col md:flex-row relative overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-6 py-8 md:py-10 max-w-7xl mx-auto w-full">
        ...
        {/* Tab: Admin */}
        {activeTab === 'admin' && <TeamManagementModule />}

        {/* Tab: Audit */}
        {activeTab === 'audit' && <AuditLogsModule />}

        {/* Tab: Templates */}
        {activeTab === 'templates' && <WhatsAppTemplatesModule />}
      </main>
