      ...
      <div className="hidden lg:flex w-[55%] flex-col justify-center px-20 relative z-10 border-r border-slate-200/50 bg-white/50 backdrop-blur-3xl">
        ...
        <div className="max-w-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="p-5 rounded-2xl bg-white border border-slate-200 hover:bg-slate-50 transition-colors">
              <ShieldCheck className="w-8 h-8 text-brand-emerald mb-3" />
              <h3 className="font-bold text-slate-900 mb-1">Sécurité Bancaire</h3>
            ...
            <div className="p-5 rounded-2xl bg-white border border-slate-200 hover:bg-slate-50 transition-colors">
              ...
              <h3 className="font-bold text-slate-900 mb-1">Analytics Avancés</h3>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center px-6 lg:px-16 relative z-10">
        ...
        <div className="w-full max-w-[420px]">
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-2">Accès Sécurisé</h2>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white/80 border border-slate-200/50 text-slate-900 placeholder-slate-600 focus:outline-none focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 focus:bg-white transition-all"
                />
              </div>
            </div>
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              ...
              className="w-full group flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-white to-slate-50 border border-slate-200 hover:border-brand-orange/40 text-left transition-all cursor-pointer shadow-sm hover:shadow-brand-orange/10"
            >
